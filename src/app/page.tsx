  ...
  return (
    <>
      <div className="hero-section">
        <h1>Tools Issue Management System</h1>
        <p>
          Streamline your workshop tool room. Register tools, issue them to mechanics, and track every transaction.
        </p>
        <div className="d-flex justify-content-center gap-3">
          <Link href="/mechanic/login" className="btn btn-primary btn-lg">
            Mechanic Login
          </Link>
          <Link href="/admin/login" className="btn btn-outline-secondary btn-lg">
            Admin Login
          </Link>
        </div>
      </div>
      ...
      <div className="row g-4 mt-3">
        ...
        <div className="col-md-6">
          <div className="feature-card">
            ...
            <Link href="/admin/register" className="btn btn-outline-secondary">
              Register as Admin
            </Link>
          </div>
        </div>
